...
class SOArm101(Robot):
    """
    Class that imports the SO_ARM101 URDF model

    ``SOArm101()`` loads the robot model from a URDF file located at:
    ...
    def __init__(self):
        ...
        links, name, urdf_string, urdf_filepath = self.URDF_read(
            "/home/iasuser/GodsonInverseKinematics/hardware-interface-fm/panda_mujoco/SO101/so101_new_calib.urdf"
            # "/home/iasuser/GodsonInverseKinematics/hardware-interface-fm/panda_mujoco/SO101/Generated_so101_urdf/so101_urdf_generated.urdf"
        )

        # self.xml_path = "/home/iasuser/GodsonInverseKinematics/hardware-interface-fm/panda_mujoco/trs_so_arm100/scene.xml"
        self.xml_path = "/home/iasuser/GodsonInverseKinematics/hardware-interface-fm/panda_mujoco/SO101/scene.xml"

        super().__init__(
            links,
            name=name,
            manufacturer="SO_ARM101",
        ...
        self.t_offset = SE3()
        # self.o_offset = SE3.RPY([-1.45514, -0.0201, 1.8114])  # For so_arm100.urdf
